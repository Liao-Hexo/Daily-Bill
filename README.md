...
> [蜗牛记账产品流程文档](https://github.com/Liao-Hexo/Daily-Bill/tree/Description/蜗牛记账-产品部分/蜗牛记账产品流程文档)、[蜗牛记账流程图、高保真原型图和需求说明](https://github.com/Liao-Hexo/Daily-Bill/tree/Description/蜗牛记账-产品部分/蜗牛记账流程图、高保真原型图和需求说明)

### 蜗牛记账-开发部分：

#### 项目介绍：

- 项目使用Swift语言编写，目前仅支持iOS平台，仅支持竖屏使用，macOS、iPadOS、watchOS、tvOS平台暂不支持。
...
- 公开：软件已在iOS App Store上架，打开iOS App Store搜索`蜗牛记账-简约精致的记账app`即可下载安装。
